                    ...
                    <div className="counts">
                      <div className="cells">
                        <div className="column-grid">
                          <div className="head fc-black-700">{user.answer_count}</div>
                          <div className="foot fc-black-500">answers</div>
                        </div>
                      </div>
                      <div className="cells">
                        <div className="column-grid">
                          <div className="head fc-black-700">{user.post_count}</div>
                          <div className="foot fc-black-500">questions</div>
                        </div>
                      </div>
                      <div className="cells">
                        <div className="column-grid">
                          <div className="head fc-black-700">{user.comment_count}</div>
                          <div className="foot fc-black-500">comments</div>
                        </div>
                      </div>
                      <div className="cells">
                        <div className="column-grid">
                          <div className="head fc-black-700">{user.tag_count}</div>
          ...
          <div className="grid-cell1">
            <div className="cell-layout">
              ...
              <div className="user-posts">
                <h3 className="fw-bold fc-dark bc-black-3">Top network posts</h3>
                <p className="fc-light">We respect a laser-like focus on one topic.</p>
              </div>
            </div>
          </div>
            ...
            <div className="top-tags">
              ...
              <div className="top-tags-sec">
                <div className="top-tags-cells">
                  <div className="top-cell">
                    <div className="tag-cell bg-black-025">
                      <TagBadge tag_name={'java'} size={'s-tag s-tag__lg'} float={'left'} />
                      <div className="score">
                ...
                <div className="top-tags-cells">
                  <div className="top-cell">
                    <div className="tag-cell bg-black-025">
                      <TagBadge tag_name={'node.js'} size={'s-tag s-tag__md'} float={'left'} />
                      <div className="score">
                        <div className="score-txt">
                          <div className="score-tab">
                            <span className="txt fc-light">Posts</span>
                ...
                <div className="top-tags-cells">
                  <div className="top-cell">
                    <div className="tag-cell bg-black-025">
                      <TagBadge tag_name={'react'} size={'s-tag s-tag__md'} float={'left'} />
                      <div className="score">
                        <div className="score-txt">
                          <div className="score-tab">
                            <span className="txt fc-light">Posts</span>
